...
$(function () {
	...
	*************************************************/
	...
	function getThemeSettings() {
		var a = localStorage.getItem('themeSettings');
        var settings = (a !== null) ? JSON.parse(localStorage.getItem('themeSettings')) : {};
...
function setUkrainian(docNum) {
	sessionStorage.setItem('lang', 1);
	localization(docNum);
}

function setEnglish(docNum) {
    sessionStorage.setItem('lang', 2);
    localization(docNum);
}

// $('#grid-table').jqGrid('setCaption', 'newCaption');

function localization(docNum) {

	var lang = sessionStorage['lang'];
		//sessionStorage.get('some') !== null
	var english = {'menu1':'Home', 'menu2':'Bushes review', 'menu3':'Treatment', 'search':'Search', 'notifications':'Notifications',
					'logout':'Logout', 'customize':'Customize', 'sidebar':'Sidebar:', 'header':'Header:', 'footer':'Footer:',
					'fixed':'fixed', 'static':'static','mapheader':'Your vineyard location', 'statisticsheader':'Statistics',
    ...
    document.getElementById('menu1').innerHTML =  language['menu1'];
    document.getElementById('menu2').innerHTML =  language['menu2'];
    document.getElementById('menu3').innerHTML =  language['menu3'];

    document.getElementById('search').placeholder = language['search'];

    document.getElementById('notifications').innerHTML = language['notifications'];
    document.getElementById('logout').innerHTML = language['logout'];

    document.getElementById('customize').innerHTML = language['customize'];
    document.getElementById('sidebar').innerHTML = language['sidebar'];
    document.getElementById('header').innerHTML = language['header'];
    document.getElementById('footer').innerHTML = language['footer'];
    document.getElementById('fixed').innerHTML = language['fixed'];
    document.getElementById('static').innerHTML = language['static'];

    if(docNum == 1) { //map
        document.getElementById('mapheader').innerHTML = language['mapheader'];
        document.getElementById('statisticsheader').innerHTML = language['statisticsheader'];
        document.getElementById('statisticssubheader').innerHTML = language['statisticssubheader'];
        document.getElementById('temperature').innerHTML = language['temperature'];
        document.getElementById('illumination').innerHTML = language['illumination'];
        document.getElementById('harvest').innerHTML = language['harvest'];
        document.getElementById('income').innerHTML = language['income'];
        document.getElementById('humidity').innerHTML = language['humidity'];
